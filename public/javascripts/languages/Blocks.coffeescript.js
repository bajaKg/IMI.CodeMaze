...
Blocks.coffeescript['loop'] = function(block, indention, generateCode){
...
Blocks.coffeescript['bool_operator'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	result.code += '(';
	result.eval += '('; 
...
Blocks.coffeescript['operator'] = Blocks.coffeescript['bool_operator'];
Blocks.coffeescript['test_operator'] = Blocks.coffeescript['bool_operator'];

Blocks.coffeescript['repeat'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	var n = block.children('input').val();
	result.code += indention+"for i in [1.."+n+"]\n";
...
Blocks.coffeescript['string'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['number'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['bool'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	result.code += block.children('.type').val();
	result.eval += block.children('.type').val();
	highlighter.addBlock(block);
...
Blocks.coffeescript['array'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	result.code += indention+'[';
	result.eval += '[';
...
Blocks.coffeescript['define_variable'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['variable'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
    var name = block.children('.name').val();
	result.code += indention+name;
	result.eval += name;
...
Blocks.coffeescript['print'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['goForward'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['turnLeft'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['turnRight'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['hasHitPig'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['say'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.coffeescript['isField'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
