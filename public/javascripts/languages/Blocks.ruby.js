...
Blocks.ruby['loop'] = function(block, indention, generateCode){
...
Blocks.ruby['bool_operator'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	result.code += '(';
	result.eval += '('; 
...
Blocks.ruby['operator'] = Blocks.ruby['bool_operator'];
Blocks.ruby['test_operator'] = Blocks.ruby['bool_operator'];

Blocks.ruby['repeat'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	var n = block.children('input').val();
	result.code += indention+"for i in 1.."+n+" do\n";
...
Blocks.ruby['string'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['number'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['bool'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	result.code += block.children('.type').val();
	result.eval += block.children('.type').val();
	highlighter.addBlock(block);
...
Blocks.ruby['array'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['define_variable'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['variable'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
    var name = block.children('.name').val();
	result.code += indention+name;
	result.eval += name;
...
Blocks.ruby['print'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
	result.code += indention+'puts ';
...
Blocks.ruby['goForward'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['turnLeft'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['turnRight'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['hasHitPig'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['say'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
...
Blocks.ruby['isField'] = function(block, indention, generateCode){
	var result = {code: "", eval: ""};
